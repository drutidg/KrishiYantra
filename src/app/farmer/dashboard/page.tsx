    ...
    <div className="space-y-4">
      ...
      <div className="pt-0.5 pb-0.5 select-none">
        <h1 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-1.5 leading-tight">
          <span>Namaste, {farmerName}</span>
          <span className="text-2xl animate-pulse">👋</span>
        </h1>
        <p className="text-xs font-medium text-slate-500 mt-0.5">
          Good morning! Here&apos;s your next booking.
        </p>
      </div>
      ...
      {activeBooking ? (
        ...
        <div className="space-y-3">
          <EmptyState
            ...
            description="You currently don't have any upcoming procurement bookings."
            actionText="Find Procurement Centers"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-800/90 font-medium mt-0.5">
              Support our farmers, strengthen our nation.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] font-medium text-slate-500 mt-0.5">
              {filteredCenters.length} centers available near you
            </p>
          </div>
          <Link
            href="/farmer/centers"
